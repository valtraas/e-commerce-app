...
<div class="mx-20 mb-20">
  ...
  <div class="bg-blue-600 rounded-xl p-4 text-2xl text-white shadow-xl">
    ...
    <div class="pt-6 mb-20">
        <div class=" border w-96 rounded-xl shadow-md dark:bg-white mt-10 mb-5">
            <div class="flex gap-6 items-center text-2xl font-bold p-2">
               <div class="bg-blue-600 rounded-xl p-4 text-2xl text-white shadow-xl">
                    ...
                    <tr class="dark:text-white">
                        ...
                        <td class="border px-4 py-2">
                            ...
                            hover:bg-yellow-600">
                                ...
                                <form action="{{ route('proses.deleted',['proses'=>$item->name]) }}" method="post">
                                    @csrf
                                    @method('DELETE')
                    ...
                    <tr class="dark:text-white">
                        ...
                        <td class="border px-4 py-2">
                            ...
                            hover:bg-yellow-600">
                                ...
                                <form action="{{ route('fitur.hapus',['fitur'=>$item->name]) }}" method="post">
                                    @csrf
                                    @method('DELETE')
                                    <button class="bg-red-600 rounded-md px-2 py-1 text-white hover:bg-red-800"
                                        onclick="return confirm('Apakah anda yakin ? ')">
