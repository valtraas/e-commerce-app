...
<div class="mx-20 mb-20">
    <div class="border w-[35%] mx-auto p-6 rounded-xl shadow-xl mb-20">
        <form action="/dashboard/proses-layanan/add" method="post" enctype="multipart/form-data">
            @csrf
<div class="mb-5">
...
<a href="/dashboard/layanan/{{ $layanan->slug }}/detail" class="text-sm text-center block mt-6 dark:text-blue-700 text-active hover:underline hover:font-bold">Kembali</a>
</form>
    </div>
